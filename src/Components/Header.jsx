...
const Header = () => {
  ...
  return (
    <header className=" bg-black py-6 px-6 flex justify-between items-center shadow-md">
        ...
        <nav className="flex items-center space-x-6 text-white font-medium">
          ...
          <button onClick={() => navigate("/")} className=" bg-gradient-to-r from-green-700 to-teal-400 hover:bg-[#1e8c6b] text-white rounded px-5 py-2 font-medium">Logout</button>
        </nav>
      </header>
  )
}
